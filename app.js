...
// document.write("Radius of a circle is: " + r);
 ...
 //document.write("<br>");
 //area = pi*r*r;
 //document.write("Area of a circle is:"+a);
...
//var num = +prompt("Enter your name :",  "enter your name");
//alert("Hello!"+name);
...
//};
//var num =2 +prompt("Enter table number");
//if (num2==num);
     // {
       // num2=5;
        //for(i=1; i<=10; i=1++);
 ...
 //var s1  = +prompt("enter maths maks");
 //var s2 = +prompt("enter englis marks");
//var  s3 = +prompt("enter urdu marks");
//var totalmarka =300;
//var obtained_mark =s1+s2+s3;
...
//document.write("</td>");
//document.write("<td>");
//var percentage =(s1*100)/totalmarka;
...
//var s2 = +prompt("enter urdu marks");
//var  s3 = +prompt("enter english marks");
//var totalmarks =300;
//var obtained_marks = s1+s+s3;   
//var percentage = (obtained_marks*100)/totalmarks;
...
//11. Write a program to create a calculator for +,-,*, / & % using if statements. Take the following input: 
         ...
         // chpter:12...13 IF…ELSE & ELSE IF STATEMENT, TESTING SET OF CONDITIONS 
...
//ii. Check if both passwords are same. If they are same, show message “Correct! The password you entered matches the original password”. Show “Incorrect password” otherwise.
 ...
 //var num3 = prompt("enter a password","Please enter your password");
 //var num4 = prompt("Confirm your password","Confirm your password");
 //if(num3==num4)
     //{
